...
enum SeedData {
    ...
    static let works: [PortfolioWork] = [
        ...
        PortfolioWork(id: "w3", stylistID: "alex-chen", title: "冷灰色歐美畫染", imageURL: "https://images.unsplash.com/photo-1522338242992-e1a54906a8da?auto=format&fit=crop&w=900&q=80"),
